...
\begin{frame}{Commutation Functions}
	...
	\end{align*}
	\vskip 0.5cm
	Application of Thiele's diff. equation:
	\begin{align*}
		\ddot{a}_{x:\overline{n}|} &= 1 + v\cdot p_x \cdot \ddot{a}_{x+1:\overline{n-1}|} \\
...
\begin{frame}{More Formulas}
	{\bfseries Life Insurance with return beneft}: in case of death before age $n$ the assets held up to that point in time paid-in premiums are returned
	\begin{align*}
