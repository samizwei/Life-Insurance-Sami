...
\begin{frame}{3.4 MC Averages Analysis}
	...
	\begin{figure}
		\includegraphics[width=1.0\textwidth]{Plots/Mean_Reserve_Estimates_with_SEM_Markov_States_34.png}
	\end{figure}
\end{frame}
...
\begin{frame}{3.5 Discussion of Risk Levels of States}
	...
	\begin{figure}
		\includegraphics[width=0.7\textwidth]{Plots/Coefficient_of_Variation_Markov_States_35.png}
	\end{figure}
	% \begin{itemize}
...
\begin{frame}{3.5 Discussion of Risk Levels of States}
	\begin{itemize}
		...
		\item So ranking the states according to their risk level (from riskiest to safest) we get:
			\begin{align*}
				(D,T) &> (D,D) >  (3,T) > (D,S) > (3,3) > (3,S) \\
				&> (T,3) > (S,D) > (S,3) > (T,D) > (S,S)
			\end{align*}
	\end{itemize}	
\end{frame}
