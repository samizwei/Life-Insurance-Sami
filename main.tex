...
\begin{frame}{Death \& Pure Endowment Insurance}
...
\begin{frame}{2.3 Benefit Level $\tilde{L}$ as a function of the number of paid premiums}
	\begin{itemize}
		...
		\begin{table}[h]
  			\begin{tabular}{|c|c|}
    		\hline
    		$k$ & $\text{Benefit Level }\prescript{}{k}{\tilde{L}}$ \\
    		\hline
    		1 & 9228.77 \\
    		2 & 18375.48 \\
			3 & 27498.51 \\
...
\begin{frame}{2.4 Which equivalence principle is fulfilled for the first premium assuming only one premium is paid.}
	\begin{itemize}
		...
		\item the benefits are computed as
			\begin{align*} 
				\mathbb{E}(benefits) &= v \cdot q_x \cdot L + v^2 \cdot \prescript{}{1}{L} \cdot p_x \cdot q_{x+1} + \dots + v^{10} \cdot \prescript{}{1}{L} \cdot p_{x+10}\\
