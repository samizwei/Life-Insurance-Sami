...
\begin{frame}{3.5 Discussion of Risk Levels of States}
	...
	\begin{itemize}
		...
		\item Directly answers: "How much money do we need to cover losses in $95\%$ of scenarios?"
		\vskip 0.3cm
...
\begin{frame}{3.6 Dicussion of Changes in Risk when changing from independent to Dependent Random Variables }
	...
	\end{align*}
	This means that if one person is disabled the other one has a 10 times higher chance of dying. 
\end{frame}
...
\begin{frame}{3.6 Dicussion of Changes in Risk when changing from independent to Dependent Random Variables }
	\begin{itemize}
		\item The CDFs for the dependent case are shifted to the left compared to the independent case.
		\item This is intuitive since the higher chance of death leads to lower expected cash flows to be paid out by the insurer.
		\item Hence the VaR at level $95 \%$ 
	\end{itemize}
\end{frame}
...
\begin{frame}{3.7 Observations}
	\begin{itemize}
		...
		\item This is intuitive since the older the person the higher the probability of death and hence the lower the expected cash flows to be paid out by the insurer.
	\end{itemize}
\end{frame}
